...
const vertical_filter = document.getElementById("vertical_filter")
...
Close_filter.addEventListener("click",function(){
    vertical_filter.style.display="none";
    overlay.style.display="none";
});

filter_icon.addEventListener("click", function(){
    if(vertical_navigation.style.display === "block"){
        vertical_navigation.style.display = "none";
        vertical_filter.style.display="block";
        overlay.style.display="block";
    } else if(vertical_filter.style.display === "none"){
        overlay.style.display="block";
...
menu_icon.addEventListener("click",function(){
    if(vertical_filter.style.display === "block"){
        vertical_filter.style.display = "none";
        vertical_navigation.style.display="block";
        overlay.style.display="block";
    } else if(vertical_navigation.style.display === "none"){
        overlay.style.display="block";
        collapsed_content.style.display="none"
        vertical_navigation.style.display ="block";
    } else{
